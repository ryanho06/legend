...
8. **Revise and move on.** Notes you authored can be reopened and edited; any note can be addended (a stamped block). Switch patients via the chart tabs, or the hamburger to return to the list. The user bubble (top right) signs you out and clears everything.
...
- **Notes.** A clinical-notes browser and editor with text search, multi-tab preview, SmartText templates, and letter-page rendering. Sign to publish a note attributed to you, Pend to file it incomplete; notes you authored can be edited, and any note can be addended.
